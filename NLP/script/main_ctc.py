...
# from https://github.com/huggingface/transformers/blob/main/examples/pytorch/speech-recognition/run_speech_recognition_ctc.py
...
def main():
    ...
    logger.setLevel(
        logging.INFO if is_main_process(training_args.local_rank) else logging.ERROR
    )

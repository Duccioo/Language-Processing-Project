...
model = SpeechRecognitionModel(model_name, device=device)
...
train_data = [
    {
        "path": "/path/to/sagan.mp3",
        "transcription": "extraordinary claims require extraordinary evidence",
    },
    {
        "path": "/path/to/asimov.wav",
        "transcription": "violence is the last refuge of the incompetent",
    },
]
eval_data = [
    {
        "path": "/path/to/sagan2.mp3",
        "transcription": "absence of evidence is not evidence of absence",
    },
    {
        "path": "/path/to/asimov2.wav",
        "transcription": "the true delight is in the finding out rather than in the knowing",
    },
]
